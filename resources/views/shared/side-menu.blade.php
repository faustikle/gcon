<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            @can('reunioes.menu')
                <li><a><i class="fa fa-group"></i> Reunião Online <span class="fa fa-chevron-down"></span></a>
            ...
            @can('ocorrencias.menu')
                <li><a><i class="fa fa-exclamation"></i> Ocorrências <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
            ...
            @can('prestadores.menu')
                <li><a><i class="fa fa-briefcase"></i> Prestadores de Serviço <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
        ...
        <ul class="nav side-menu">
            @can('moradores.menu')
                <li><a><i class="fa fa-user"></i> Moradores <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
